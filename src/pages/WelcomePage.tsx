    ...
    <div className="relative mx-auto w-full max-w-sm md:max-w-none">
      ...
      <div className="relative space-y-2 lg:space-y-3">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="animate-welcome-float-delayed flex shrink-0 items-center gap-1.5 rounded-full border border-white/10 bg-white/10 px-2.5 py-1 text-[11px] font-medium text-white/80 backdrop-blur-sm lg:px-3 lg:py-1.5 lg:text-xs">
            <Video className="h-3 w-3 text-emerald-400 lg:h-3.5 lg:w-3.5" />
            Live đang diễn ra
          </div>
        </div>

        <div className="animate-welcome-float rounded-2xl border border-white/10 bg-white/[0.07] p-3 shadow-2xl shadow-emerald-950/40 backdrop-blur-sm lg:p-4">
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[100dvh] w-full max-w-4xl flex-col items-center justify-center px-6 py-10 sm:px-8">
        ...
        <div className="relative mt-8 flex w-full flex-col gap-3 sm:mt-10 sm:w-auto sm:flex-row sm:justify-center">
          ...
          <Link
            to="/auth/login"
            className="inline-flex min-h-11 items-center justify-center rounded-xl border border-white/20 px-7 text-sm font-semibold text-white/85 transition-colors hover:border-white/35 hover:bg-white/5 sm:min-w-[140px]"
          >
            Đăng nhập
          </Link>
        </div>
