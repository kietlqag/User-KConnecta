...
export function AddToCollectionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col max-h-[560px]">
        {/* Header */}
        <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-200 shrink-0">
          ...
          <h3 className="flex-1 text-base font-bold text-gray-900">
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto py-1">
              ...
              >
                ...
                <span className="text-[15px] font-semibold text-gray-900">Tạo bộ sưu tập mới</span>
              </button>
                ...
                filtered.map((col) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="flex-1 text-[15px] font-medium text-gray-900 truncate">{col.name}</span>
                      {isLoading ? (
