...
export function AddToCollectionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm bg-card rounded-xl shadow-2xl border border-border overflow-hidden flex flex-col max-h-[560px]">
        {/* Header */}
        ...
        {isCreating ? (
          ...
          <div className="p-4 flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="flex items-start justify-between mt-1">
                ...
                <p className={`text-xs ml-auto ${newName.length > 50 ? 'text-red-500' : 'text-muted-foreground'}`}>
                  {newName.length}/50
                </p>
              </div>
            </div>
          ...
          <>
            ...
            <div className="px-3 py-2.5 border-b border-border shrink-0">
              <div className="flex items-center gap-2 px-3 py-2 bg-background rounded-full">
            ...
            <div className="flex-1 overflow-y-auto py-1">
              ...
              >
                ...
                <span className="text-[15px] font-semibold text-foreground">Tạo bộ sưu tập mới</span>
              </button>
                ...
                filtered.map((col) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="flex-1 text-[15px] font-medium text-foreground truncate">{col.name}</span>
                      {isLoading ? (
