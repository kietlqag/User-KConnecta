...
function StatCard({ icon, label, value, sub, color }: { icon: React.ReactNode; label: string; value: string | number; sub?: string; color: string }) {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 flex items-start gap-3 shadow-sm dark:shadow-none hover:shadow-md transition-shadow">
...
function Toggle({ checked, onChange, disabled }: { checked: boolean; onChange: (v: boolean) => void; disabled?: boolean }) {
  return (
    <button
      ...
      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${checked ? 'bg-violet-600' : 'bg-gray-300 dark:bg-gray-600'} ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
    >
      <span className={`inline-block h-4 w-4 transform rounded-full bg-white dark:bg-gray-800 shadow transition-transform ${checked ? 'translate-x-6' : 'translate-x-1'}`} />
    </button>
  );
}
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100">AI Moderation Dashboard</h2>
            <p className="text-xs text-gray-500 dark:text-gray-400">Giám sát và kiểm soát nội dung tự động bằng AI</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className={`flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full ${cfg.enabled ? 'bg-green-100 text-green-700' : 'bg-gray-100 dark:bg-gray-900 text-gray-500 dark:text-gray-400'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm dark:shadow-none overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 text-violet-600" />
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-sm">Cấu hình AI</h3>
          </div>
          <div className="p-5 space-y-5">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-semibold text-gray-900 dark:text-gray-100 text-sm">AI Enabled</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Bật/tắt toàn bộ hệ thống AI Moderation</p>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <p className="font-semibold text-gray-900 dark:text-gray-100 text-sm">Sensitivity</p>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{sensitivityInfo.desc}</p>
            </div>

            {/* Detect toggles */}
            <div>
              <p className="font-semibold text-gray-900 dark:text-gray-100 text-sm mb-3">Phát hiện</p>
              <div className="space-y-2.5">
                {([
                  ...
                  <div key={key} className="flex items-center justify-between py-1">
                    <span className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">{icon}{label}</span>
            ...
            {/* Auto actions */}
            <div>
              <p className="font-semibold text-gray-900 dark:text-gray-100 text-sm mb-3">Hành động tự động</p>
              <div className="space-y-2.5">
                {([
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm dark:shadow-none overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 flex items-center gap-2">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-sm">AI Test Panel</h3>
          </div>
          <div className="p-5 space-y-4">
            <textarea
              ...
              rows={4}
              className="w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2.5 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-violet-400 transition-shadow placeholder:text-gray-400"
            />
            <button
            ...
            {testResult && (
              <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
                {/* Overall */}
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Overall Risk Score</span>
                  ...
                  {testResult.categories.map(cat => (
                    <div key={cat.label}>
                      <div className="flex items-center justify-between mb-1">
                        <span className={`text-xs font-medium flex items-center gap-1 ${cat.triggered ? 'text-red-600' : 'text-gray-500 dark:text-gray-400'}`}>
                          {cat.triggered && <span className="w-1.5 h-1.5 rounded-full bg-red-500 inline-block" />}
                          {cat.label}
                        </span>
                        <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">{cat.score}%</span>
                      </div>
                ...
                {/* Predicted action */}
                <div className="mt-3 rounded-lg border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 px-4 py-3 flex items-center justify-between">
                  <span className="text-sm text-gray-600 dark:text-gray-400 font-medium">Hành động dự kiến</span>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm dark:shadow-none overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 flex items-center gap-2">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-sm">Score Range → Action Rules</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60">
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Score Range</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Action</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Trạng thái</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Mô tả</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {[
                ...
                <tr key={row.range} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                  <td className="px-5 py-3.5 font-mono font-semibold text-gray-800 dark:text-gray-200">{row.range}</td>
                  ...
                  <td className="px-5 py-3.5">
                    <span className={`flex items-center gap-1.5 text-xs font-medium ${row.active ? 'text-green-600' : 'text-gray-400'}`}>
                      <span className={`w-2 h-2 rounded-full ${row.active ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'}`} />
                      {row.active ? 'Active' : 'Inactive'}
                    </span>
                  </td>
                  <td className="px-5 py-3.5 text-gray-500 dark:text-gray-400">{row.desc}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm dark:shadow-none overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-violet-600" />
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-sm">Recent Moderation Activity</h3>
          </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/60">
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Thời gian</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Loại</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Nội dung</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">AI Score</th>
                <th className="text-left px-5 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Action</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {MOCK_ACTIVITY.map(item => (
                <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                  ...
                  <td className="px-5 py-3.5 text-gray-500 dark:text-gray-400 max-w-[200px] truncate">{item.content}</td>
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">{item.score}%</span>
                    </div>
                  </td>
                  <td className="px-5 py-3.5">
