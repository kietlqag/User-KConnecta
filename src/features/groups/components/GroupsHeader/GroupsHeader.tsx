      ...
      <div className="max-w-[1920px] mx-auto px-4">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2 flex-1 justify-end max-w-[320px]">
            <button className="p-2 bg-background hover:bg-muted rounded-full transition-colors lg:hidden">
            ...
            <button 
              ...
              className={`hidden sm:flex p-2 hover:bg-muted rounded-full transition-colors ${ isMenuOpen ? 'bg-emerald-100' : 'bg-background' }`}
              title="Menu"
              aria-label="Menu"
            ...
            <button 
              ...
              className="hidden sm:flex relative p-2 bg-background hover:bg-muted rounded-full transition-colors"
            >
