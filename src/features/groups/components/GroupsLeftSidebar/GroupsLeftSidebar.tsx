      ...
      <div className="p-4">
        ...
        <div className="space-y-1 mb-4">
          {sidebarSections.map((section) => (
            ...
            >
              <div className={section.active ? 'text-blue-600' : 'text-gray-600'}>
                {section.icon}
              </div>
        ...
        {/* Create Group Button */}
        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg bg-gray-100 hover:bg-gray-200 transition-colors mb-4">
