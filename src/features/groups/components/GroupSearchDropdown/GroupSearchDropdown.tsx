...
export function GroupSearchDropdown({
  ...
  return (
    <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-xl border border-gray-200 z-50 overflow-hidden max-h-[min(420px,60vh)] flex flex-col">
          ...
          <div className="px-2 pb-1">
            ...
            {localGroups.slice(0, 5).map(group => (
              ...
              >
                ...
                <span className="font-medium text-[15px] text-gray-900 truncate">{group.name}</span>
              </button>
            ))}
          </div>
        )}
