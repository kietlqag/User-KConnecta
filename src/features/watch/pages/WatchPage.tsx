...
const mockReels: Reel[] = [
  {
    ...
    creator: {
      id: '101',
      name: 'Sinh viên HCMUTE - Trý?ng ÐH Công ngh? K? thu?t TPHCM',
    ...
    caption: 'L? t?t nghi?p HCMUTE nãm nay... Xem thêm',
    music: {
  ...
  },
  {
    ...
    caption: 'Ch?ng ðý?ng tr?i nghi?m ð?y c?m xúc, xem ð?n cu?i nhé!',
    music: {
      name: 'Âm thanh g?c',
  ...
  },
  {
    ...
    caption: 'Hý?ng d?n trang ði?m t? nhiên cho mùa hè ?? #makeup #beauty',
    music: {
      name: 'Summer Vibes',
      artist: 'Chill Beats',
    },
  ...
  '1': [
    {
      ...
      content: 'Có l? ðây là m?t trong nh?ng kho?nh kh?c ð?p nh?t c?a trý?ng. Xem thêm',
      timestamp: '3 ngày',
      likes: 21,
    },
    {
      ...
      content: 'Hai m? con r?t vui, c?m õn Minh Th?.',
      timestamp: '4 ngày',
      likes: 13,
    },
    {
      ...
      content: 'Cô bé nói gi?ng mi?n Trung, không bi?t là B?nh Ð?nh hay Phú Th? ta ??',
      timestamp: '4 ngày',
      likes: 13,
    },
    {
  ...
  '2': [
    {
      ...
      content: 'N?i dung r?t hay và ? ngh?a!',
      timestamp: '2 gi?',
      likes: 45,
    },
    {
  ...
  '3': [
    {
      ...
      content: 'Tutorial r?t d? hi?u, c?m õn b?n!',
      timestamp: '1 ngày',
      likes: 89,
    },
  ],
