        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {incomingMediaType === 'video' ? 'Ðang g?i video cho b?n' : 'Ðang g?i tho?i cho b?n'}
            </p>
          </div>
      ...
      >
        ...
        {isVideoCall ? (
          <>
            <div className="relative overflow-hidden rounded-xl bg-black h-[360px]">
              ...
              />
              {!hasRemoteStream && (
                <div className="absolute inset-0 flex items-center justify-center text-sm text-white/80">Ðang ch? video...</div>
              )}
            </div>
        ...
        <div className="mt-6 flex items-center justify-center gap-4">
          <button
            ...
            title={speakerMode === 'outer' ? 'Ðang loa ngoài, b?m ð? chuy?n loa trong' : 'Ðang loa trong, b?m ð? chuy?n loa ngoài'}
          >
            {speakerMode === 'outer' ? (
