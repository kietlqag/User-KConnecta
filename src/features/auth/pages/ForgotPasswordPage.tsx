      ...
      case "email":
        return (
          <form onSubmit={handleEmailSubmit} className="space-y-6">
            ...
            <Link to="/auth/login" className="flex items-center justify-center gap-2 text-sm text-gray-600 hover:text-gray-900 transition-colors mt-4">
              <ArrowLeft size={16} />
              Quay lại đăng nhập
            </Link>
          </form>
        ...
        return (
          <form onSubmit={handleOTPSubmit} className="space-y-6">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-1">Xác thực OTP</h2>
            ...
            <button type="button" onClick={() => setStep("email")} className="flex items-center justify-center gap-2 w-full text-sm text-gray-600 hover:text-gray-900 transition-colors">
              <ArrowLeft size={16} />
              Thay đổi email
            </button>
          </form>
