  ...
  <div className="flex items-center justify-between rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
    <div className="flex items-center gap-3">
      <Link to={`/profile/${friend.userId}`}>
        <div className="h-14 w-14 shrink-0 overflow-hidden rounded-full border border-gray-200">
          <ImageWithFallback
            src={friend.avatar}
            alt={friend.name}
...
export const BirthdayTab = () => {
  ...
  return (
    <div className="max-w-2xl space-y-4">
      {upcoming.length > 0 && (
        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900">Sinh nhật sắp tới</h2>
