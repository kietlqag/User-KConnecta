          ...
          <div className="space-y-2">
            {audienceOptions.map((option) => {
              ...
              return (
                ...
                >
                  <div
                    className={`flex h-12 w-12 items-center justify-center rounded-full ${ isSelected ? 'bg-emerald-100 dark:bg-emerald-900/40' : 'bg-muted' }`}
                  >
                    <Icon
                      className={`h-6 w-6 ${ isSelected ? 'text-emerald-600 dark:text-emerald-400' : 'text-foreground' }`}
                    />
                  </div>
                  ...
                  <div
                    className={`flex h-5 w-5 items-center justify-center rounded-full border-2 ${ isSelected ? 'border-emerald-600 dark:border-emerald-400' : 'border-gray-400 dark:border-gray-500' }`}
                  >
