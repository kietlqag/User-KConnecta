...
export function AnimatedCharactersLoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (email === "erik@gmail.com" && password === "1234") {
      alert("Ðãng nh?p thành công! Chào m?ng Erik!");
    } else {
      setError("Email ho?c m?t kh?u chýa ðúng. Vui l?ng th? l?i.");
    }
      ...
      <div className="flex items-center justify-center bg-background p-8">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="text-sm text-muted-foreground">Vui l?ng nh?p thông tin ðãng nh?p</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" className="h-12 w-full text-base font-medium" size="lg" disabled={isLoading}>
              {isLoading ? "Ðang ðãng nh?p..." : "Ðãng nh?p"}
            </Button>
          </form>
