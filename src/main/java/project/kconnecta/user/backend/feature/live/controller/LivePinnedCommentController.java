...
public class LivePinnedCommentController {
    ...
    public ResponseEntity<LivePinnedCommentResponse> getPinnedComment(
            @AuthenticationPrincipal UserPrincipal principal) {
        return ResponseEntity.ok(livePinnedCommentService.getPinnedComment(principal.getUserId()));
    }
}
